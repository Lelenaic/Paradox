...
class Utilitaires {
  ...
  public static function mustLogged(): void {
  ...
  public static function dateUS2FR(string $dateus): string {
    $datefr=explode('-',$dateus);
    return $datefr[2].'/'.$datefr[1].'/'.$datefr[0];
  }

  public static function dateFR2US(string $datefr): string {
    $dateus=explode('/',$datefr);
    return $dateus[2].'-'.$dateus[1].'-'.$dateus[0];
  }

  public static function urlIncorrect(): void {
