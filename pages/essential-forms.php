            ...
            <ul class="nav navbar-nav navbar-nav-margin-left">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="essential-forms.html">Forms</a></li>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group margin-none">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="reservation" id="reservationtime" class="form-control daterangepicker-reservation" value="07/10/2014 1:00 PM - 07/10/2014 1:30 PM" />
                            </div>
                        </div>
                    </div>
                </div>
