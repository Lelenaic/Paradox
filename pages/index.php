    ...
    <div class="parallax-layer overlay overlay-full overlay-bg-white bg-transparent" data-speed="8" data-opacity="true">
        <div class="v-center">
            <div class="page-section overlay-bg-white-strong relative paper-shadow" data-z="1">
                <img src="images/logo.png" width="90px" height="90px" /><br>
                <h1 class="text-display-2 margin-v-0-15 display-inline-block"><?= _NOM_ ?></h1>
                <p class="text-subhead">La simplicité au bout des doigts.</p>
                <a class="btn btn-green-500 btn-lg paper-shadow" data-hover-z="2" data-animated href="./login">Accéder à mon espace professionnel</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="parallax-layer overlay overlay-full overlay-bg-white bg-transparent" data-opacity="true" data-speed="8">
        <div class="v-center">
            <div class="page-section">
                <h1 class="text-display-2 overlay-bg-white margin-v-0-15 inline-block">Feedback</h1><br/>
                        ...
                        <form action="#" data-toggle="wizard" class="max-width-400 h-center">
                            ...
                            <fieldset class="step relative paper-shadow form-horizontal" data-z="2">
                                <div class="page-section-heading">
                                    ...
                                    <h3 class="text-h4 margin-v-10 text-grey-400">Your plan is <strong class="text-uppercase">learner</strong> for <strong>&dollar;19.99/mo</strong></h3>
