                ...
                <div class="panel panel-default paper-shadow" data-z="0.5">
                    <div class="panel-body">
                        ...
                        <div class="media media-clearfix-xs">
                            ...
                            <div class="media-body">
                                <h4 class="text-headline margin-v-5-0"><a href="website-course.html">Github Webhooks for Beginners</a></h4>
                                <p class="small">
                                ...
                                <div class="media v-middle">
                                    ...
                                    <div class="media-body">
                                        <h4><a href="">Adrian Demian</a><br/></h4>
                                        Instructor
                                    </div>
                                </div>
                ...
                <div class="panel panel-default paper-shadow" data-z="0.5">
                    <div class="panel-body">
                        ...
                        <div class="media media-clearfix-xs">
                            ...
                            <div class="media-body">
                                <h4 class="text-headline margin-v-5-0"><a href="website-course.html">CSS Awesomeness with LESS Processing</a></h4>
                                <p class="small">
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                ...
                <div class="panel panel-default paper-shadow" data-z="0.5">
                    <div class="panel-body">
                        ...
                        <div class="media media-clearfix-xs">
                            ...
                            <div class="media-body">
                                <h4 class="text-headline margin-v-5-0"><a href="website-course.html">Portable Environments with Vagrant</a></h4>
                                <p class="small">
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                ...
                <div class="panel panel-default paper-shadow" data-z="0.5">
                    <div class="panel-body">
                        ...
                        <div class="media media-clearfix-xs">
                            ...
                            <div class="media-body">
                                <h4 class="text-headline margin-v-5-0"><a href="website-course.html">WordPress Theme Development</a></h4>
                                <p class="small">
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                ...
                <div class="panel panel-default paper-shadow" data-z="0.5">
                    <div class="panel-body">
                        ...
                        <div class="media media-clearfix-xs">
                            ...
                            <div class="media-body">
                                <h4 class="text-headline margin-v-5-0"><a href="website-course.html">Writing Modular JavaScript with Browserify</a></h4>
                                <p class="small">
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
                                    <span class="fa fa-fw fa-star text-yellow-800"></span>
