...
<circle cx="70.688" cy="19.042" r="3.167"/>
        ...
        <div class="collapse navbar-collapse" id="main-nav">
            <ul class="nav navbar-nav navbar-nav-margin-left">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                        <li class="active"><a href="essential-buttons.html">Buttons</a></li>
    ...
    <h1>Buttons</h1>
    <p>Use any of the available button classes to quickly create a styled button, whether it's a regular, stroked or stacked button. Group a series of buttons together on a single line with the button group. Add on optional JavaScript radio and checkbox style behavior.</p>
</div>
...
<div class="page-section">
    <div class="row">
        <div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
            ...
            <h4 class="page-section-heading">Regular Buttons</h4>
            <div class="panel panel-default">
                <div class="panel-body buttons-spacing-vertical">
                    <p>Regular buttons with various colours for quickly creating styled buttons.</p>
                    <p>
            ...
            <h4 class="page-section-heading">Stacked Buttons</h4>
            <div class="panel panel-default">
                <div class="panel-body buttons-spacing-vertical">
                    <p>Stacked Buttons with two lines of text and icon. All regular button styles can be used with stacked buttons.</p>
                    <p>
                        ...
                        <button class="btn btn-info btn-icon-stacked"><i class="fa fa-2x fa-dribbble"></i> <span>Join using your<br>Dribble Account</span></button>
                    </p>
                </div>
            </div>

            <h4 class="page-section-heading">Button Sizes</h4>
            <div class="panel panel-default">
                <div class="panel-body buttons-spacing-vertical">
                    <p>Various buttons sizes for common scenarios, from large buttons, to medium sized, small and very small buttons.</p>
            ...
            <h4 class="page-section-heading">Button Icons</h4>
            <div class="panel panel-default">
                <div class="panel-body buttons-spacing-vertical">
                    <p>
            ...
            <h4 class="page-section-heading">Buttons with Dropdown</h4>
            <div class="panel panel-default">
                <div class="panel-body buttons-spacing-vertical">
            ...
            <h4 class="page-section-heading">Buttons with Stroke</h4>
            <div class="panel panel-default">
                <div class="panel-body buttons-spacing-vertical">
                    <p>Inverse button colors for text, background and border attributes and get a stroked button.</p>
                    <p>
