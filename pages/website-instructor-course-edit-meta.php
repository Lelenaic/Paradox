            ...
            <div class="col-md-9">
                ...
                <div class="tabbable paper-shadow relative" data-z="0.5">
                    ...
                    <ul class="nav nav-tabs">
                        <li><a href="website-instructor-course-edit-course.html"><i class="fa fa-fw fa-lock"></i> <span class="hidden-sm hidden-xs">Course</span></a></li>
                        <li class="active"><a href="website-instructor-course-edit-meta.html"><i class="fa fa-fw fa-credit-card"></i> <span class="hidden-sm hidden-xs">Meta</span></a></li>
