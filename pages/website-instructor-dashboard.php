...
<div class="container">
	...
	<div class="media-body">
		<p class="text-subhead">
			<a href="#"><img src="images/people/110/guy-2.jpg" alt="person" class="width-30 img-circle"/></a> &nbsp;
            <a href="#">mosaicpro</a>
			<span class="text-caption text-light">44 min ago</span>
		</p>
	</div>
	<div class="media-right">
...
<p class="text-light"><span class="caption">Course:</span> <a href="app-student-course.html">Basics Of HTML</a></p></li>
	...
	<div class="media-body">
		<p class="text-subhead">
			<a href="#"><img src="images/people/110/guy-3.jpg" alt="person" class="width-30 img-circle"/></a> &nbsp;
            <a href="#">mosaicpro</a>
...
<p class="text-light"><span class="caption">Course:</span> <a href="app-student-course.html">Basics Of HTML</a></p></li>
	...
	<div class="media-body">
		<p class="text-subhead">
			<a href="#"><img src="images/people/110/guy-1.jpg" alt="person" class="width-30 img-circle"/></a> &nbsp;
            <a href="#">mosaicpro</a>
			<span class="text-caption text-light">27 min ago</span>
		</p>
	</div>
	<div class="media-right">
		<div class="width-50 text-right">
...
<p class="text-light"><span class="caption">Course:</span> <a href="app-student-course.html">Basics Of HTML</a></p></li>
	...
	<div class="media-body">
		<p class="text-subhead">
			<a href="#"><img src="images/people/110/guy-2.jpg" alt="person" class="width-30 img-circle"/></a> &nbsp;
            <a href="#">mosaicpro</a>
			<span class="text-caption text-light">42 min ago</span>
		</p>
	</div>
	<div class="media-right">
		<div class="width-50 text-right">
...
<p class="text-light"><span class="caption">Course:</span> <a href="app-student-course.html">Basics Of HTML</a></p></li>
	...
	<div class="media-body">
		<p class="text-subhead">
			<a href="#"><img src="images/people/110/guy-4.jpg" alt="person" class="width-30 img-circle"/></a> &nbsp;
            <a href="#">mosaicpro</a>
                ...
                <table class="table text-subhead v-middle">
                    <tbody>
                        <tr>
                            ...
                            <td>Adrian Demian</td>
                            <td class="width-80 text-center"><a href="#">#2384</a></td>
                            <td class="width-50 text-center">&dollar;67</td>
                        </tr>
                        <tr>
                            <td class="width-100 text-caption"><div class="label label-grey-200 label-xs">12 Jan 2015</div></td>
                            <td>Adrian Demian</td>
                            <td class="width-80 text-center"><a href="#">#6930</a></td>
                            <td class="width-50 text-center">&dollar;86</td>
                        </tr>
                        <tr>
                            <td class="width-100 text-caption"><div class="label label-grey-200 label-xs">12 Jan 2015</div></td>
                            <td>Adrian Demian</td>
                            <td class="width-80 text-center"><a href="#">#10975</a></td>
                            <td class="width-50 text-center">&dollar;85</td>
                        </tr>
                        <tr>
                            <td class="width-100 text-caption"><div class="label label-grey-200 label-xs">12 Jan 2015</div></td>
                            <td>Adrian Demian</td>
                            <td class="width-80 text-center"><a href="#">#9681</a></td>
                            <td class="width-50 text-center">&dollar;9</td>
                        </tr>
                    </tbody>
                </table>
            </div>
