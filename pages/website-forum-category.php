                ...
                <div class="panel panel-default paper-shadow" data-z="0.5">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item media v-middle">
                            ...
                            <div class="media-body">
                                ...
                                <div class="text-light text-caption">
                                    posted by
                                    <a href="#"><img src="images/people/110/guy-6.jpg" alt="person" class="img-circle width-20" /> Adrian Demian</a> &nbsp;
                                    | <i class="fa fa-clock-o fa-fw"></i> 5 mins
                                </div>
                            </div>
                            <div class="media-right">
                                <a href="website-forum-thread.html" class="btn btn-white text-light"><i class="fa fa-comments fa-fw"></i> 17</a>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item media v-middle">
                            ...
                            <div class="media-right">
                                <a href="website-forum-thread.html" class="btn btn-white text-light"><i class="fa fa-comments fa-fw"></i> 14</a>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item media v-middle">
                            ...
                            <div class="media-right">
                                <a href="website-forum-thread.html" class="btn btn-white text-light"><i class="fa fa-comments fa-fw"></i> 4</a>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item media v-middle">
                            ...
                            <div class="media-right">
                                <a href="website-forum-thread.html" class="btn btn-white text-light"><i class="fa fa-comments fa-fw"></i> 11</a>
                            </div>
                        </li>
