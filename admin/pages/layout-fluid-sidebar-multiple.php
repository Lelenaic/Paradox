...
<body class="layout-container ls-top-navbar layout-sidebar-l3-md-up layout-sidebar-r3-xl-up">
  ...
  <nav class="navbar navbar-light bg-white navbar-full navbar-fixed-top ls-left-sidebar">
    ...
    <button class="navbar-toggler pull-xs-right" type="button" data-toggle="sidebar" data-target="#sidebarRight"><span class="material-icons">menu</span></button>

    <!-- Brand -->
    <a class="navbar-brand first-child-md" href="index.html">Multiple Sidebars</a>
  ...
  <!-- // END Sidebar -->
  <!-- Sidebar -->
  <div class="sidebar sidebar-right sidebar-size-3 sidebar-visible-xl-up sidebar-light bg-white ls-top-navbar-xs-up" id="sidebarRight" data-position="right" data-visible="xl-up" data-scrollable>

    <!-- Activity -->
    <div class="sidebar-heading sidebar-p-t">Activity</div>
    <ul class="sidebar-activity">
      <li class="media active">
        <div class="media-left">
          <div class="sidebar-activity-icon">
