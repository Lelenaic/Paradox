...
<body class="layout-container ls-top-navbar layout-sidebar-l3-md-up">
  ...
  <nav class="navbar navbar-light bg-white navbar-full navbar-fixed-top ls-left-sidebar">
    ...
    <!-- Brand -->
    <a class="navbar-brand first-child-md" href="index.html">Notes</a>
    ...
    <!-- Toggle -->
    <button class="navbar-toggler text-primary pull-xs-right hidden-md-up" type="button" data-toggle="sidebar" data-target="#sidebarRight"><span class="material-icons">note</span></button>
  ...
  <div class="sidebar sidebar-right sidebar-size-3 sidebar-visible-md-up sidebar-light bg-white ls-top-navbar-xs-up" id="sidebarRight" data-position="right" data-scrollable>
    ...
    <!-- Sidebar Notes -->
    <div class="sidebar-block center sidebar-p-y">
