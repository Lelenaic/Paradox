...
<div class="layout-content" data-scrollable>
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <a href="./ajouter_categorie" class="btn btn-primary btn-rounded-deep m-l-1" style="margin-top:10px;">Nouvelle catégorie <i class="material-icons">add</i></a>
            <?php
            echo $categories->messages();
            echo $categories->afficherTableau();
            ?>
