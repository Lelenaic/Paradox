...
<body class="layout-container ls-top-navbar layout-sidebar-l3-md-up">
  ...
  <!-- Navbar -->
  <nav class="navbar navbar-dark bg-primary navbar-full navbar-fixed-top ls-left-sidebar">
    ...
    <!-- Brand -->
    <a class="navbar-brand first-child-md" href="index.html">Colored Navbar</a>
